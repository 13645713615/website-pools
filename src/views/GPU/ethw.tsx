 ...
 * @version: 
 * @Author: Carroll
 * @Date: 2022-09-15 12:06:30
 * @LastEditTime: 2022-09-15 13:04:06
 */
...
export default class EthDescriptions implements Descriptions {
    ...
    public section = {
        p1: (<>支持ETHW的交易所一般会提供钱包充值，例如 <a href="https://www.binance.com/en/register?ref=B2675KF5" target="_blank">币安 （推荐链接）</a> 、火币网、<a href="https://www.coinbase.com" target="_blank">Coinbase</a> 等。</>),
    ...
    public get node() {
        return [<span>stratum+tcp://hk1-ssl.lhtop.net:5588</span>]
    }
}
