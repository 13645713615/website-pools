...
export default {
    ...
    message: {
        ...
        tip: {
            ...
            empty: "暂无{coin}数据",
            automaticWithdrawal: "打开自动提币后，当日满足起付额{threshold}后，次日将自动支付。关闭自动提币后，即使您达到起付额，也将暂停支付收益，直到您手动开启自动提币开关。",
        ...
        help: {
            ...
            h3: "3. 如何配置多种自动分账方案？",
            t3: "每个子账户仅支持设置一套方案；切换子账户后，可配置新的分账方案。例如：lh_a 设置自动提币到 A、B 钱包， lh_b 设置提币到 B、C 钱包"
        },
    }
}